					...
					<table class="table table-bordered table-hover">
						...
						<tr height="30" class="success" align="center">
							...
							<td width="250">
								...
								%> <img src="<%=contextPath%>/img/level.gif" width="<%=wid%>"
								height="16"> <%}%> 
								<a href="<%=contextPath%>/jdbc/content?num=<%=article.getNum()%>&pageNum=<%=vo.getCurrentPage()%>&cmd=content">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ul class="pagination pagination-sm pagination-center">
								...
								%>
								<li><a
									href="<%=contextPath%>/jdbc/board?pageNum=<%=i%>"><%=i%></a></li>
								<%
									}
										if (endPage < pageCount) {
								%>
								<li><a href="<%=contextPath%>/jdbc/board?pageNum=<%=startPage + 10%>">[다음]</a></li>
								<%}
									}%>
							</ul>
						</div>
